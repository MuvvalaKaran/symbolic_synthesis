'''
This file contains the code to call the old V1.0 code's search algorithms.

The codes implemented in this Tag are slow compare to future versions. 
'''
...
from src.algorithms.old_disjoint_search.blind_search import MultipleFormulaBFS
from src.algorithms.weighted_search import SymbolicDijkstraSearch
from src.algorithms.old_disjoint_search.weighted_search import MultipleFormulaDijkstra
