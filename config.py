...
VAR_DICT = {
    ...
    "GRIDWORLD": GRIDWORLD,
    "FRANKAWORLD": FRANKAWORLD,
    "STRATEGY_SYNTHESIS": STRATEGY_SYNTHESIS,
    "REGRET_SYNTHESIS": REGRET_SYNTHESIS,
    "REGRET_HYBRID": REGRET_HYBRID,
    "MONOLITHIC_TR": MONOLITHIC_TR,
    "TWO_PLAYER_GAME":TWO_PLAYER_GAME,
    "TWO_PLAYER_GAME_BND": TWO_PLAYER_GAME_BND,
    "GAME_ALGORITHM": GAME_ALGORITHM,
    "HUMAN_INT_BND": HUMAN_INT_BND,
    "DIJKSTRAS": DIJKSTRAS,
    "ASTAR": ASTAR,
    "USE_LTLF": USE_LTLF,
    "DRAW_EXPLICIT_CAUSAL_GRAPH": DRAW_EXPLICIT_CAUSAL_GRAPH,
    "SIMULATE_STRATEGY": SIMULATE_STRATEGY,
    "GRID_WORLD_SIZE": GRID_WORLD_SIZE,
    "OBSTACLE": OBSTACLE,
    "DYNAMIC_VAR_ORDERING": DYNAMIC_VAR_ORDERING,
    "SUP_LOC": SUP_LOC,
    "TOP_LOC": TOP_LOC,
    "formulas": formulas,
